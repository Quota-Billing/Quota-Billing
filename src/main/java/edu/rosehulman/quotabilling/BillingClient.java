...
public class BillingClient {
  ...
  public boolean addUser(String partnerId, String productId, String userId) throws Exception {
    ...
    HttpResponse<String> response = Unirest.post(Paths.BILLING_BASE + "addUser/partner/{partnerId}/product/{productId}/user/{userId}").routeParam("partnerId", partnerId).routeParam("productId", productId).routeParam("userId", userId).asString();
